...
model_function = llm_i.call_qwen3vl_model
...
# CHANGED: added model and processor arguments
#timestamp_start_is_photo_analysis, timestamp_end_is_photo_analysis, image_descr = analyse_giub_img_dir_llm(jpg_data_path, prompt_func, model_function, model, processor)
...
filename = 'ml_metrics_multi_object_struct_qwen3vl_' + timestamp_id + '.csv'
...
filename = 'img_closer_insp_multi_object_struct_qwen3vl_' + timestamp_id + '.pkl'
...
filename = 'responses_multi_object_struct_qwen3vl_' + timestamp_id + '.pkl'
...
results_file_name = 'results_multi_object_struct_qwen3vl_' + timestamp_id + '.pkl'
...
time_analyses_df_file_name = 'times_multi_object_struct_qwen3vl_' + timestamp_id + '.pkl'
